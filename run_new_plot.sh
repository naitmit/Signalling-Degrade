...
do
  ...
  then
      ...
      cp plot_newvar* laguerre_testing* ./plot_progress${i}
      ...
      time python3.7 plot_newvar.py

      rm plot_newvar* laguerre_testing*
      ...
      if [ ! -e ../plotting/$day/$now ] #if progam finishes on a different minute
      then
          cd ../
          echo "Moving files"
